document.addEventListener('DOMContentLoaded', () => {
    ...
    function initParticleManagement() {
        ...
        const saveBtn = articleForm.querySelector('.save-btn');
        ...
        // Helper to set modal fields editable or read-only
        function setModalEditable(editable) {
            document.getElementById('article-title').readOnly = !editable;
            document.getElementById('article-content').readOnly = !editable;
            if (editable) {
                saveBtn.style.display = '';
            } else {
